...
app.use(cors({
  origin: ['https://rr-course.vercel.app','http://localhost:3000'],
  methods: ['GET', 'POST', 'DELETE', 'UPDATE', 'PUT', 'PATCH'],
  credentials: true
}));
...
app.use((req, res, next) => {
  const allowedOrigins = ['https://rr-course.vercel.app/','http://localhost:3000/']; // Replace with your allowed origins
